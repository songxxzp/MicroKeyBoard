...
from microkeyboard.constants import KEYBOARD_REPORT_DESC, IO_CAPABILITY_NO_INPUT_OUTPUT, IRQ_CENTRAL_CONNECT, IRQ_CENTRAL_DISCONNECT, IRQ_GATTS_WRITE, IRQ_GATTS_READ_REQUEST, IRQ_ENCRYPTION_UPDATE, IRQ_GET_SECRET, IRQ_SET_SECRET, IRQ_MTU_EXCHANGED, IRQ_CONNECTION_UPDATE, FLAG_READ, FLAG_WRITE_NO_RESPONSE, FLAG_WRITE, FLAG_NOTIFY
